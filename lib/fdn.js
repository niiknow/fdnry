...
/***/ function(module, exports, __webpack_require__) {
	...
	var _feedinaryEdit = __webpack_require__(161);
	...
	var Feedinary = function () {
	  ...
	  _createClass(Feedinary, [{
	    ...
	    key: 'getContent',
	    value: function getContent(name, item) {
	      var that = this;
	      var rst = {};
	    ...
	    key: 'renderItem',
	    value: function renderItem(name, item) {
	      var cancel = false;
	      var rst = {
	        rendered: 0,
	        canceled: 0
	      ...
	      if (!cancel) {
	        // get the item
	        var _item = this.getContent(name, _item);
	
	        el.html('').html(_item.html || '');
	        if (_item.iframe) {
	          var descEl = el.find('.fdn-desc');
	
	          debug('rendering iframe for item ' + name);
	          util.createiFrame(descEl, _item.desc);
	        }
	        rst.rendered++;
	
	        // trigger on after render
	        if (this.onAfterRender) this.onAfterRender(name, _item);
	      } else {
	    ...
	    value: function processCache() {
	      ...
	      util.each(that.cache, function (v, k) {
	        if (v.dataurl) {
	          var p = util.request({ url: v.dataurl });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ready = __webpack_require__(117);
	...
	var _trim = __webpack_require__(145);
	
	var _trim2 = _interopRequireDefault(_trim);
	
	var _debug = __webpack_require__(153);
	...
	var Util = function () {
	  ...
	  _createClass(Util, [{
	    ...
	    key: 'createiFrame',
	    value: function createiFrame(parentEl, content) {
	      var doc = void 0,
	          iframe = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(16),
	    baseKeys = __webpack_require__(18),
	    indexKeys = __webpack_require__(19),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseTimes = __webpack_require__(20),
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignInDefaults = __webpack_require__(119),
	    assignInWith = __webpack_require__(120),
	    attempt = __webpack_require__(134),
	    baseValues = __webpack_require__(136),
	    escapeStringChar = __webpack_require__(138),
	    isError = __webpack_require__(135),
	    isIterateeCall = __webpack_require__(124),
	    keys = __webpack_require__(15),
	    reInterpolate = __webpack_require__(139),
	    templateSettings = __webpack_require__(140),
	    toString = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflect = __webpack_require__(132),
	    iteratorToArray = __webpack_require__(133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(141),
	    reEscape = __webpack_require__(143),
	    reEvaluate = __webpack_require__(144),
	    reInterpolate = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeHtmlChar = __webpack_require__(142),
	    toString = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseToString = __webpack_require__(106),
	    castSlice = __webpack_require__(146),
	    charsEndIndex = __webpack_require__(148),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var myContent = __webpack_require__(160);
	var util = new _util2.default();
	...
	var FeedinaryEdit = function () {
	  function FeedinaryEdit(fdn) {
	    ...
	    // load edit on demand
	    var src = fdn.src.replace('/fdn.', '/fdn-edit.');
	    var that = this;
	  ...
	  _createClass(FeedinaryEdit, [{
	    key: 'editItem',
	    value: function editItem(name, item) {
	      name = util.slugify(name).replace('fdn_', '');
